...
var getScopedModules = function getScopedModules(scope) {
    var modules = {};
    var command = 'du --max-depth 1 -k --exclude ".*" node_modules/' + scope;
...
var getSizeForNodeModules = function getSizeForNodeModules() {
    var modules = {};
    var command = 'du --max-depth 1 -k --exclude ".*" node_modules | sort -k2';
...
var attachNestedDependencies = function attachNestedDependencies(rootDependencies) {
    ...
    try {
        for (var _iterator4 = rootDependencies[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var getAllDependencies = function getAllDependencies(flatDependencies) {
    ...
    try {
        for (var _iterator5 = flatDependencies[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
