...
var _require = require('colors'), yellow = _require.yellow
...
var getDependenciesRecursively = function getDependenciesRecursively() {
  var modules = arguments.length > 0 && arguments[0] !== undefined
    ? arguments[0]
    : []
...
*/
var attachNestedDependencies = function attachNestedDependencies(
  rootDependencies
) {
...
var displayResults = function displayResults(
  ...
  for (var i = 0; i < sortedDependencies.length; i++) {
    ...
    if (argv.less && i === 10) {
      table.push([
        '+ ' + (sortedDependencies.length - 10) + ' modules',
        null,
        null,
      ])
      break
