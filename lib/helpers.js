...
var getSizeForNodeModules = function getSizeForNodeModules() {
    var modules = {};
    var command = 'du --max-depth 1 -k node_modules';
...
var displayResults = function displayResults(flatDependencies, allDependencies, totalSize) {
    ...
    try {
        for (var _iterator5 = flatDependencies[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            ...
            table.push([dep.name, dep.numberOfChildren, (dep.actualSize / 1024).toFixed(2) + 'M']);
        }
    ...
    table.push([yellow(flatDependencies.length + ' modules'), yellow(allDependencies.length - flatDependencies.length + ' children'), yellow((totalSize / 1024).toFixed(2) + 'M')]);
